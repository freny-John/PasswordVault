...
public class PMContentProvider extends android.content.ContentProvider {
	private static final int INCOMING_ACCOUNT_COLLECTION_URI_INDICATOR =1;
	private static final int INCOMING_ACCOUNT_SINGLE_URI_INDICATOR =2;
	private static final HashMap<String, String> sAccountProjectionMap;
